...
U 1 1 5D9A16C2
P 6250 1250
F 0 "J4" H 6307 1717 50  0000 C CNN
F 1 "USB_B_Mini" H 6307 1626 50  0000 C CNN
F 2 "Connector_USB:USB_Mini-B_Wuerth_65100516121_Horizontal" H 6400 1200 50  0001 C CNN
...
U 1 1 5D9A41CB
P 6250 1750
F 0 "#PWR0101" H 6250 1500 50  0001 C CNN
...
Wire Wire Line
	6850 1350 6550 1350
$Sheet
S 7450 950  1950 1100
U 5DA09855
F0 "usb_uart" 50
F1 "usb_uart.sch" 50
F2 "USB_VBUS" I L 7450 1050 50 
F3 "USB_DM" B L 7450 1450 50 
F4 "USB_DP" B L 7450 1350 50 
F5 "UART_RTS" O R 9400 1350 50 
F6 "UART_CTS" I R 9400 1450 50 
F7 "UART_TXD" O R 9400 1250 50 
F8 "UART_RXD" I R 9400 1150 50 
F9 "CBUS0" B R 9400 1600 50 
F10 "CBUS1" B R 9400 1700 50 
F11 "CBUS2" B R 9400 1800 50 
F12 "CBUS3" B R 9400 1900 50 
$EndSheet
Wire Wire Line
	6850 1450 7450 1450
Wire Wire Line
...
U 1 1 5DC9507C
P 6900 1050
F 0 "D4" H 6900 834 50  0000 C CNN
F 1 "B140-E3" H 6900 925 50  0000 C CNN
F 2 "Diode_SMD:D_SMA" H 6900 875 50  0001 C CNN
F 3 "http://www.vishay.com/docs/88946/b120.pdf" H 6900 1050 50  0001 C CNN
	1    6900 1050
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 5DE528BD
P 900 7450
AR Path="/5DE528BD" Ref="#PWR?"  Part="1" 
...
U 1 1 5DE52B90
P 900 6900
AR Path="/5DE52B90" Ref="#PWR?"  Part="1" 
...
U 1 1 5DE52D8C
P 1350 6900
AR Path="/5DE52D8C" Ref="#PWR?"  Part="1" 
...
U 1 1 5DE52FC5
P 1350 7450
AR Path="/5DE52FC5" Ref="#PWR?"  Part="1" 
